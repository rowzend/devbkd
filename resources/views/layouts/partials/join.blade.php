            ...
            <div class="main-panel">
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Pranata Komputer <a
                                href="https://bkpsdm.pesisirsealtankab.go.id/" target="_blank">Bkpsdm Kab. Pesisir
                                Selatan</a>
                            IV Jurai, Painan. Indonesia.</span>
