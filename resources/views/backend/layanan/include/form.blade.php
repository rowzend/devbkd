<div class="row">
    <div class="mb-3 col-md-6">
        ...
        <input class="form-control @error('nama') is-invalid @enderror" type="text" name="nama"
            value="{{ isset($service) ? $service->nama : old('nama') }}" />
        @error('nama')
    ...
    <div class="mb-3 col-md-12">
        ...
        <textarea class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" cols="20" rows="7">{{ isset($service) ? $service->deskripsi : old('deskripsi') }}</textarea>
        @error('deskripsi')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
